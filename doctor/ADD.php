				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="Symp" placeholder="Symptops" required>
							</div>
                            <div class="form-group">
								<input type="text" class="form-control" name="pres" placeholder="Prescription" required>
							</div>
                            <div class="form-group">
								<input type="text" class="form-control" name="dia" placeholder="Diagnosis" required>
							</div>
							<div class="form-group">
								<label class="block">
									Gender
